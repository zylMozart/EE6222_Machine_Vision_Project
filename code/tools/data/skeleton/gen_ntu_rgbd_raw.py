...
def gendata(data_path,
    ...
    for filename in os.listdir(data_path):
        if filename in ignored_samples or filename=='xsub':
            continue
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='data/ntu/nturgb+d_skeletons_60_3d')
    parser.add_argument(
        '--ignored-sample-path',
        type=str,
        default='data/ntu/NTU_RGBD_samples_with_missing_skeletons.txt')
    parser.add_argument(
        '--out-folder', type=str, default='data/ntu/nturgb+d_skeletons_output')

...
def parse_args():
    ...
    parser.add_argument('--src_dir', default='data/ntu_dark/rawframes_train', type=str, help='source video directory')
    parser.add_argument('--out_dir', default='data/ntu_dark_extracted', type=str, help='output rawframe directory')
    parser.add_argument(
        '--task',
        type=str,
        default='rgb',
